...
Let us look at another application of Liouville's Theorem. 
\begin{example}
...
\end{corollary}
\begin{proof}
    From \thref{thm:open-mapping}, it is immediate that $f$ is a homeomorphism. Let $g = f^{-1}$. We have $g\circ f = \mathbf id$, from which the conclusion follows.
\end{proof}
