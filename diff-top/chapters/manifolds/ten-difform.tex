...
\end{theorem}
\begin{proof}
    We shall provide a proof of the statement only for $T^k(TM)$. We contend that $T^k(TM)$ is a smooth vector bundle of rank $n^k$ over $M$. \todo{use \thref{lem:vector-bundle-chart}}
\end{proof}