...
\begin{proof}
    ...
    Due to \thref{lem:normal-compositum-of-sep-insep}, there are subfields $F_0$ and $E$ of $F$ such that $F = F_0E$, $E/k$ is purely inseparable and $F_0$ is the separable closure of $k$ in $F$. Since $F_0/k$ is a finite separable extension, due to \thref{thm:primitive-element-theorem}, there is some $\beta\in F_0$ such that $F_0 = k(\beta)$. 
