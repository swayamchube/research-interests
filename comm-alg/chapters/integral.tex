...
\begin{proposition}\thlabel{prop:unique-prime-lying-over}
...
\subsection{Another Proof of the Going Down Theorem}
\begin{lemma}
...
\begin{proof}
    ...
    Suppose first that \todo{proof in lang seems fishy}
\end{proof}
...
\begin{theorem}\thlabel{thm:jacobson-rings-equivalent}
...
\begin{definition}[Jacobson Ring]
    The ring $A$ is said to be \emph{Jacobson} if it satisfies the equivalent conditions of \thref{thm:jacobson-rings-equivalent}.
\end{definition}