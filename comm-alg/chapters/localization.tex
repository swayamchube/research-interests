...
\end{proposition}
\begin{proof}
    That $(a)\Longrightarrow(b)\Longrightarrow(c)$ is obvious. We shall show $(c)\Longrightarrow(a)$. 
\end{proof}
...
\end{proposition}
\begin{proof}
    Let $A$ be a nonzero integral domain and consider the ring $R = A\times A$. This is not an integral domain. Due to \thref{prop:localization-of-product}, every localization of $R$ is isomorphic to $A_{\frakp}$ where $\frakp\in\spec A$, consequently, is an integral domain. 
